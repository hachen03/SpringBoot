...
public class PersonController {
       ...
       {
    	   Person person=personService.getPersonBydate(date);
            return person;
       }
       //取得某一歲數以上的Person
       public Person getPersonByage(int age)
       {
    	   Person person=personService.getPersonByage(age);
    			   return person;
       }
       //根據姓名來修改Person的生日
       public Person setPersonByname(String name,Date date)
       {
    	   Person person=personService.setPersonByname(name, date);
    	   return person;
       }
       //根據姓名來刪除Person
